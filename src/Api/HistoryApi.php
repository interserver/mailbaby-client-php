...
class HistoryApi
{
     ...
     * @return \Interserver\Mailbaby\Model\MailStatsType|\Interserver\Mailbaby\Model\ErrorMessage
     */
    public function getStats($time = '1h', string $contentType = self::contentTypes['getStats'][0])
    {
     ...
     * @throws \Interserver\Mailbaby\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \Interserver\Mailbaby\Model\MailStatsType|\Interserver\Mailbaby\Model\ErrorMessage, HTTP status code, HTTP response headers (array of strings)
     */
    public function getStatsWithHttpInfo($time = '1h', string $contentType = self::contentTypes['getStats'][0])
    {
     ...
     */
    public function getStatsAsync($time = '1h', string $contentType = self::contentTypes['getStats'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getStatsAsyncWithHttpInfo($time = '1h', string $contentType = self::contentTypes['getStats'][0])
    {
     ...
     */
    public function getStatsRequest($time = '1h', string $contentType = self::contentTypes['getStats'][0])
    {
     ...
     * @param  \Interserver\Mailbaby\Model\DateOrTimestamp|null $startDate Earliest date to include.  Accepts either a Unix timestamp (integer seconds since epoch) or a date string parseable by &#x60;strtotime()&#x60; such as &#x60;2024-01-15&#x60; or &#x60;last monday&#x60;.  Messages with a &#x60;time&#x60; value **greater than or equal to** this value will be included. (optional)
     * @param  \Interserver\Mailbaby\Model\DateOrTimestamp|null $endDate Latest date to include.  Accepts either a Unix timestamp (integer seconds since epoch) or a date string parseable by &#x60;strtotime()&#x60; such as &#x60;2024-01-31&#x60; or &#x60;yesterday&#x60;. Messages with a &#x60;time&#x60; value **less than or equal to** this value will be included. (optional)
