...
class MailLogEntry implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets id
     *
     * @param int $id Internal auto-increment database row ID.  Not meaningful outside the API.
     *
     * @return self
     */
     ...
     * Sets messageId
     *
     * @param string|null $messageId The `Message-ID` header value, if present.  Can be used with the `messageId` filter on `GET /mail/log` for subsequent lookups.
     *
     * @return self
     */
     ...
     * Sets mxHostname
     *
     * @param string|null $mxHostname The MX hostname the relay connected to for delivery.  Corresponds to the `mx` filter parameter on `GET /mail/log`.
     *
     * @return self
     */
