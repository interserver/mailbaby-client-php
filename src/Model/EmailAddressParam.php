...
/**
 * EmailAddressParam Class Doc Comment
 *
 * @category Class
 ...
 */
class EmailAddressParam implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'EmailAddressParam';
     ...
     * Sets email
     *
     * @param string $email The email address to delist from all block lists.
     *
     * @return self
     */
