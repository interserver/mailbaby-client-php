...
class MailAttachment implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets filename
     *
     * @param string $filename The filename shown to recipients (e.g. `report.pdf`, `invoice.xlsx`).
     *
     * @return self
     */
     ...
     * Sets data
     *
     * @param string $data The file contents as a base64-encoded string.  Decode this to retrieve the original binary file.
     *
     * @return self
     */
