 ...
 */
class MailBlocks implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'MailBlocks';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('mbtrap', $data ?? [], null);
    ...
    {
        if (is_null($mbtrap)) {
            throw new \InvalidArgumentException('non-nullable mbtrap cannot be null');
        }
