...
/**
 * EmailAddressTypes Class Doc Comment
 *
 * @category Class
 ...
 */
class EmailAddressTypes implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'EmailAddressTypes';
     ...
     * Sets name
     *
     * @param string|null $name Optional display name shown to recipients (e.g. in the `From:` header).
     *
     * @return self
     */
