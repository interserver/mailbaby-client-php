 ...
 */
class SendMailRaw implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SendMailRaw';
    ...
    {
        $this->setIfExists('rawEmail', $data ?? [], null);
    ...
    {
        if (is_null($rawEmail)) {
            throw new \InvalidArgumentException('non-nullable rawEmail cannot be null');
        }
     ...
     * Sets id
     *
     * @param int|null $id Optional numeric ID of the mail order to use for SMTP authentication. If omitted the first active order on your account is used.  Valid IDs are returned by `GET /mail`.
     *
     * @return self
     */
